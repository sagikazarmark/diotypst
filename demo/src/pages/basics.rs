...
pub fn Home() -> Element {
    ...
    rsx! {
        ...
        DocsCallout {
            ...
            "The workspace is split into typst-embed (Dioxus-independent Project World construction) and diotypst (render hooks, components, downloads, package preparation, and the fullstack server routes). Design terminology lives in CONTEXT.md."
        }
    }
}
